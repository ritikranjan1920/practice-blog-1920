...
from main.users.forms import RegistrationForm, LoginForm, UpdateAccountForm, ResetPasswordForm, RequestResetForm
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email has been sent with the token', 'info')
        return redirect(url_for('users.login'))
